#############################################################################
# Makefile for building: WaccoinGold-qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: Mon Jul 28 03:34:46 2014
# Project:  waccoingold-qt.pro
# Template: app
# Command: c:\Qt\4.8.6\bin\qmake.exe USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile waccoingold-qt.pro
#############################################################################
...
Makefile: waccoingold-qt.pro  ../Qt/4.8.6/mkspecs/default/qmake.conf ../Qt/4.8.6/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile waccoingold-qt.pro
...
clean: release-clean debug-clean FORCE
	-$(DEL_FILE) C:/waccoin-gold-master/src/leveldb/libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) C:/waccoin-gold-master/src/leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) $(MAKE)
	-$(DEL_FILE) clean
...
C:/waccoin-gold-master/src/leveldb/libleveldb.a: FORCE
