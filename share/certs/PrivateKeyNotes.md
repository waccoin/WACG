...
unlocked to sign the WaccoinGold-Qt.app bundle.
...
allowing somebody to distribute a WaccoinGold-Qt.app or waccoingold-qt-setup.exe with a valid
...
that the waccoingold-qt.exe file inside the installer had not been tampered with.
