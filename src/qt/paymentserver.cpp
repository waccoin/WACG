...
const QString BITCOIN_IPC_PREFIX("waccoingold:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click waccoingold: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start waccoingold: click-to-pay handler");
    else
...
{
    // clicking on waccoingold: URLs creates FileOpen events on the Mac:
