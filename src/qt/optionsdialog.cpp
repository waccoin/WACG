    ...
    fProxyIpValid(true)
{
    ...
    ui->unit->setModel(new WaccoinGoldUnits(this));
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->waccoingoldAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::showRestartWarning_Proxy()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting WaccoinGold."), QMessageBox::Ok);
